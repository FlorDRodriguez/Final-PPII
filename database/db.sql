...
CREATE TABLE cursos (
    ...
    CONSTRAINT fk_profesor FOREIGN KEY(profesor) REFERENCES profesores(nroBono),
    libro INT(11),
...
CREATE TABLE anuncios (
    ...
    profesor INT(11) NOT NULL,
    CONSTRAINT fk_profesor_anuncio FOREIGN KEY(profesor) REFERENCES profesores(nroBono),
    tipo INT(1) NOT NULL,
...
CREATE TABLE asistenciaCursos (
    ...
    CONSTRAINT fk_alumno FOREIGN KEY(alumno) REFERENCES alumnos(legajo),
    curso INT(11) NOT NULL,
...
CREATE TABLE listaAlumnos (
    ...
    alumno INT(11) NOT NULL,
    CONSTRAINT fk_alumno_lista FOREIGN KEY(alumno) REFERENCES alumnos(legajo),
    curso INT(11) NOT NULL,
...
CREATE TABLE clases (
    ...
    presentes INT(11) NOT NULL,
    CONSTRAINT fk_presentes FOREIGN KEY(presentes) REFERENCES alumnos(legajo),
    ausentes INT(11) NOT NULL,
    CONSTRAINT fk_ausentes FOREIGN KEY(ausentes) REFERENCES alumnos(legajo),
    PRIMARY KEY (idClase)
